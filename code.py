...
y_train.dropna()
y_test.dropna()
dm=X_train['bra_size'].mean()
X_train['bra_size'].fillna(dm)
bm=X_test['bra_size'].mean()
X_test['bra_size'].fillna(bm)
cm=X_train['hips'].mean()
X_train['hips'].fillna(cm)
vm=X_test['hips'].mean()
X_test['hips'].fillna(vm)
